...
class RemoteConfig {
    private val default: Map<String, Any> = mapOf(
        ...
        SHOW_AD_ON_SEARCH_CLICK to false,
        SHOW_AD_ON_HOME_SCREEN_NATIVE to false,
        SHOW_AD_ON_HOME_SCREEN_IAP_SELECTION to false,
        SHOW_AD_ON_HOME_SCREEN_VPN_SELECTION to false,
        SHOW_AD_ON_HOME_SCREEN_SERVER_SELECTION to false,
        SHOW_AD_ON_HOME_SCREEN_SETTING_SELECTION to false,
        SHOW_AD_ON_HOME_SCREEN_LOADING_DIALOG to false,
        SHOW_AD_ON_SERVER_SCREEN_NATIVE to false,
        SHOW_AD_ON_SERVER_SCREEN_VPN_SELECTION to false,
        SHOW_AD_ON_SERVER_SCREEN_IAP_SELECTION to false,
        SHOW_AD_ON_SERVER_SCREEN_BACK_SELECTION to false,
        SHOW_AD_ON_SERVER_SCREEN_SERVER_SELECTION to false,
        SHOW_AD_ON_SERVER_SCREEN_LOADING_DIALOG to false,
        SHOW_AD_ON_RESULT_SCREEN_NATIVE to false,
        SHOW_AD_ON_RESULT_SCREEN_IAP_SELECTION to false,
        SHOW_AD_ON_RESULT_SCREEN_VPN_SELECTION to false,
        SHOW_AD_ON_RESULT_SCREEN_BACK_SELECTION to false,
        SHOW_AD_ON_WEB_SCREEN_NATIVE to false,
        SHOW_AD_ON_WEB_SCREEN_VPN_SELECTION to false,
        SHOW_AD_ON_WEB_SCREEN_IAP_SELECTION to false,
        SHOW_AD_ON_WEB_SCREEN_BACK_SELECTION to false,
        SHOW_AD_ON_WEB_SCREEN_LOADING_DIALOG to false,
        SHOW_AD_ON_SETTING_SCREEN_NATIVE to false,
        SHOW_AD_ON_SETTING_SCREEN_VPN_SELECTION to false,
        SHOW_AD_ON_SETTING_SCREEN_IAP_SELECTION to false,
        SHOW_AD_ON_SETTING_SCREEN_BACK_SELECTION to false,
    )
